...
const pageContent = {
    ...
    'NCC': [
        { isHeader: true, html: '<span style="display:none">Wikipedia NCC</span><iframe src="http://161.118.185.109:8080" width="100%" height="840px"></iframe>' }
    ],
	'NSE': [
        { isHeader: true, html: '<span style="display:none">Wikipedia NCC</span><iframe src="http://161.118.185.109:7010" width="100%" height="840px"></iframe>' }
    ]
};